            ...
            <div class="modal-content">
                ...
                <div id="modalBody" class="modal-body">
                    <div class=" row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4 py-1 d-flex justify-content-center">
                        ...
                        <button wire:click="show_patient" class="col btn btn-primary mx-2">
                            Voir le profil patient
                        </button>

                        @if ($status == "OUI") 
                            <button wire:click="show_consultation" class="col btn btn-primary bg-cp mx-2">
                                 Voir la Consultation
                            </button>
                        @else 
                            <button wire:click="show_visite" class="col btn btn-primary bg-cp mx-2">
                                Creer Consultation
                            </button>

                            {{-- <button wire:ignore wire:click="delete" class="col btn btn-outline-danger  mx-2">
                                Supprimer la visite
                            </button> --}}
                        @endif
