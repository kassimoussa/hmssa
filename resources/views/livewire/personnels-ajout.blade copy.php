                    ...
                    <div class="col-6 text-end pe-3">
                        <div class="row">
                            <div class="">
                                ...
                                <button type="reset" class="btn btn-outline-danger btn-square fw-bold"
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="row me-1 ">
                            ...
                            <div class="mt-2 col-4">
                                <label for="matricule" class="form-label text-muted fw-italic mb-0">Matricule *</label>
                                <div class="input-group">
                                    <span class="input-group-text txt fw-bold  text-white">
                            ...
                            <div class="mt-2 col-4">
                                <label for="fonction" class="form-label text-muted fw-italic mb-0">Fonction *</label>
                                <div class="input-group">
                                    <span class="input-group-text txt fw-bold  text-white">
                            ...
                            <div class="mt-2 col-4">
                                <label for="date_embauche" class="form-label text-muted fw-italic mb-0">Date d'embauche
                                    *</label>
                                <div class="input-group">
                                    <span class="input-group-text txt fw-bold  text-white">
                            ...
                            <div class="mt-2  col-4">
                                <label for="telephone" class="form-label text-muted fw-italic mb-0">Telephone *</label>
                                <div class="input-group">
                                    <span class="input-group-text txt fw-bold  text-white">
                            ...
                            <div class="mt-2 col-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="username" wire:model.defer="username"
                                        placeholder="Le nom d'utilisateur" required>
                                </div>
                                <span class="text-danger">
                                    @error('username')
                                    {{ $message }}
                            ...
                            <div class="mt-2 col-4">
                                <label for="password" class="form-label text-muted fw-italic mb-0">Password *</label>
                                <div class="input-group">
                                    <span class="input-group-text txt fw-bold  text-white">
