...
<div class="py-3 ">
    ...
    <div class="d-flex justify-content-between mb-3 ">
        ...
        <div class="">
            <a class="btn btn-primary bg-cp square border-0 fw-bold"
                data-bs-toggle="modal" data-bs-target="#newpatient">
                    ...
                    <div class="modal-body px-3">
                        <div class="row   ">
                            <div class="col-6 ">
                                ...
                                {{-- <div class=" mt-2 col-12 d-flex justify-content-center align-items-center position-relative">
                                    ...
                                    <a id="imgupload" class="" onclick="$('#imginput').trigger('click'); return false;"
                                        ...
                                        title="Clicker pour ajouter la photo du patient ">
                                        <img alt="Photo du patient" hover="Photo du patient" src="{{ asset($url) }}"
                                ...
                                <div class="mt-2 col-12 ">
                                 ...
                                 <div class="mt-2 ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="adresse" wire:model.defer="adresse" cols="5" rows="5"></textarea>
                                    </div>
                                    <span class="text-danger">
                                        @error('adresse')
                                        {{ $message }}
                            ...
                            <div class="col-6 row ">
                                ...
                                <div class="mt-2 col-12 ">
                                    <label for="lieu_naissance" class="form-label text-muted fw-italic mb-0">Lieu de naissance *</label>
                                    <div class="input-group">
                                        <span class="input-group-text txt fw-bold  text-white">
                                            <i class="fa-solid fa-city icnbgc"></i>
                                        </span>
                                        <input type="text" class="form-control" id="lieu_naissance" wire:model.defer="lieu_naissance"
                                            placeholder="Lieu de naissance du patient" required>
                                    </div>
                                    <span class="text-danger">
                                ...
                                <div class="mt-2 col-12 ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select wire:model.defer="affiliation" class="form-select" id="affiliation">
                                            <option value="" selected>Select</option>
                                            <option value="Le (la) militaire">Le (la) militaire</option>
                        ...
                        <div class="row   ">
                            <div class="col-6 ">
                                ...
                                <div class=" mt-2 col-12 d-flex justify-content-center align-items-center position-relative">
                                    ...
                                    <input type="file" wire:model="filename2" id="imginput" class="dimage"
                                        style="display: none;" onchange="readURL(this);" accept="image/*">
                                    <span class="text-danger">
                                        @error('photo')
                                        {{ $message }}
                                ...
                                <div class="mt-2 col-12 ">
                                 ...
                                 <div class="mt-2 ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control" id="adresse2" wire:model.defer="adresse2" cols="5" rows="5">  </textarea>
                                    </div>
                                    <span class="text-danger">
                                        @error('adresse2')
                                        {{ $message }}
                            ...
                            <div class="col-6 row ">
                                ...
                                <div class="mt-2 col-12 ">
                                    <label for="lieu_naissance2" class="form-label text-muted fw-italic mb-0">Lieu de naissance *</label>
                                    <div class="input-group">
                                        <span class="input-group-text txt fw-bold  text-white">
                                            <i class="fa-solid fa-city icnbgc"></i>
                                        </span>
                                        <input type="text" class="form-control" id="lieu_naissance2" wire:model.defer="lieu_naissance2"
                                            placeholder="Lieu de naissance du patient" required>
                                    </div>
                                    <span class="text-danger">
                                ...
                                <div class="mt-2 col-12 ">
                                    <label for="telephone2" class="form-label text-muted fw-italic mb-0">Telephone *</label>
                                    <div class="input-group">
                                        <span class="input-group-text txt fw-bold  text-white">
                                            <i class="fa-solid fa-phone icnbgc"></i>
                                        </span>
                                ...
                                <div class="mt-2 col-12 ">
                                    <label for="affiliation2" class="form-label text-muted fw-italic mb-0">Affiliation *</label>
                                    <div class="input-group">
                                        <span class="input-group-text txt fw-bold  text-white">
                                            <i class="fa-solid fa-link icnbgc"></i>
                                        </span>
    ...
    <div class="col ">
        ...
        <table class="table table-bordered border-dark table-striped table-hover table-sm align-middle " id="">
            ...
            <tbody class="text-center">
                ...
                @php
                if($patient->filename){
                $photo = $patient->storage_path;
                } else {
                $photo = 'https://ui-avatars.com/api/?size=235&name=' . $patient->nom;
                }
                @endphp

                <tr>
                    <td>{{ $cnt }}</td> 
                    <td><img style="width: 60px; height: 60px; oject-fit: cover;" src="{{ asset($photo) }}"  alt="Photo du patient"> </td>
                    ...
                    <td class="td-actions ">
                        <a class="btn  " href="{{ url("/patients/show", $patient->id ) }}" title="Voir la fiche du patient ">
